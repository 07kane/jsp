	...
	<div id="wrap">
		...
		<nav class="bg-danger d-flex align-items-center">
			<ul class="nav nav-fill w-100 d-flex justify-content-between">
				<li class="nav-item"><a href="http://localhost:8080/jsp/test/total1.jsp?category=all" class="nav-link text-white">전체</a></li>
		...
		<section class="contents">
			<table border="1" class="table text-center table-bordered text-center">
				...
				{
					if(targetCategory.equals(channer.get("category")) || targetCategory.equals("all"))
					{
				%>
					<tr>
